...
def parse_arguments():
    ...
    parser.add_argument(
        "--input_path",
        default="./data/processed23/cached_128.txt",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        default="./checkpoints/elc_bert_base_small_gradAcc_23",
        type=str,
    ...
    parser.add_argument(
        "--vocab_path",
        default="./tokenizers/tokenizer_small_10M_23.json",
        type=str,
    ...
    parser.add_argument(
        "--wandb_entity", type=str, default="activebaby", help="Your WANDB username/entity."
    )
    parser.add_argument(
        "--wandb_name", type=str, default="test-ELC-BERT", help="WANDB run name."
    )
