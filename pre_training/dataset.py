...
class Dataset(Dataset):
    def __init__(self,
        ...
        self.mask_index = self.tokenizer.token_to_id("[MASK]")
        # print("original self.mask_index", self.mask_index)
        # print("w encode self.mask_index", self.tokenizer.encode("[MASK]").ids)
        # print("=============>")
        ...
        # Load lines
        if type(file) == str:
            line_list = open(file, 'r')
        # Load dataset from df
        elif type(file) == pd.DataFrame:
            line_list = file['line'].to_list()
        else:
            line_list = []
