...
def parse_arguments():
    ...
    parser.add_argument(
        "--output_dir",
        default="./checkpoints/ACLM_elc_bert_base_small_24_50K_EP2",
        type=str,
...
if __name__ == "__main__":
    ...
    for epoch in count(initial_epoch):
        ...
        print('Initial_indices', initial_indices, len(initial_indices))
